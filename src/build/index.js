...
var _isValidHex = _interopRequireDefault(require("./Utils/isValidHex.js"));
var _isColored = _interopRequireDefault(require("./Utils/isColored.js"));
...
class Colorizer {
  ...
  addCustomRGBColor(name, background, rgb) {
    Object.defineProperty(this.customColors, name, {
      value: function (text) {
